...
# 🧪 17. Luồng kiểm thử toàn bộ hệ thống

Phần này mô tả một luồng kiểm thử hoàn chỉnh cho toàn bộ hệ thống CarCare Manager.

Mục tiêu của luồng kiểm thử là kiểm tra các chức năng chính của hệ thống trong **một phiên sử dụng xe duy nhất**.

Người kiểm thử sẽ mô phỏng quá trình sử dụng và quản lý một chiếc xe từ lúc bắt đầu phiên đến khi kết thúc phiên.
...
* Một chiếc xe được khởi tạo.
* Các danh sách dữ liệu bắt đầu ở trạng thái rỗng.
* Menu chính được hiển thị.

---

## 🚘 Bước 2: Kiểm tra thông tin xe
...
1. Xem thông tin xe.
2. Cập nhật số kilomet hiện tại.
...
```text
Số kilomet hiện tại: 1250 km
```

### Kết quả mong đợi

Thông tin xe được hiển thị chính xác.
...
## 🛣️ Bước 3: Kiểm tra quản lý chuyến đi
...
### Thêm chuyến đi thứ hai

```text
Ngày: 18/07/2026
Điểm đi: Thành phố Hồ Chí Minh
Điểm đến: Củ Chi
Quãng đường: 80 km
Chế độ lái: Eco
```
...
```text
Tổng số chuyến: 2
Tổng quãng đường: 200 km
Chuyến đi dài nhất: 120 km
```

---

## ⚡ Bước 4: Kiểm tra theo dõi năng lượng
...
```text
Lượng pin đã sử dụng: 25%
```

Kiểm tra lại lịch sử năng lượng.

### Kết quả mong đợi

* Dữ liệu năng lượng được thêm thành công.
* Thông tin hiển thị chính xác.

---

## 🔧 Bước 5: Kiểm tra quản lý bảo dưỡng
...
1. Xem lịch sử bảo dưỡng.
2. Kiểm tra cảnh báo bảo dưỡng.

### Kết quả mong đợi

Lịch sử bảo dưỡng được hiển thị chính xác.
...
## 💰 Bước 6: Kiểm tra quản lý chi phí
...
```text
Tổng chi phí: 620000 VND
```

Chi phí theo nhóm:

```text
Năng lượng: 120000 VND
Bảo dưỡng: 500000 VND
```

---

## 🔍 Bước 7: Kiểm tra tình trạng xe
...
Hệ thống hiển thị trạng thái của từng bộ phận.

Đồng thời, hệ thống phải phát hiện:

```text
⚠️ Đèn xe đang có vấn đề
```

---

## ⚠️ Bước 8: Kiểm tra quản lý vấn đề và cảnh báo
...
1. Xem các vấn đề đang tồn tại.
2. Kiểm tra vấn đề vừa thêm.
3. Đóng vấn đề.
...
## 🧰 Bước 9: Kiểm tra quản lý phụ kiện
...
### Thêm phụ kiện thứ nhất

```text
Tên: Camera hành trình
Chi phí: 1500000 VND
```

### Thêm phụ kiện thứ hai
...
```text
Số phụ kiện: 2
Tổng chi phí phụ kiện: 4500000 VND
```

---

## 📊 Bước 10: Kiểm tra báo cáo phiên sử dụng
...
Hệ thống hiển thị đầy đủ thông tin tổng hợp:
...
Các thông tin trong báo cáo phải khớp với dữ liệu đã nhập trong các module trước đó.

---

## 🔄 Bước 11: Kiểm tra dữ liệu trong cùng một phiên

Quay lại từng module và kiểm tra lại:
...
Dữ liệu đã nhập trước đó vẫn tồn tại trong phiên hiện tại.

---

## 🚪 Bước 12: Kiểm tra kết thúc phiên
...
Hệ thống hiển thị báo cáo phiên sử dụng trước khi kết thúc.

Sau đó chương trình kết thúc.

---

## 🔁 Bước 13: Kiểm tra dữ liệu bị xóa sau khi thoát
...
Tất cả dữ liệu của phiên trước **không còn tồn tại**.
...
Nếu toàn bộ các bước trên được thực hiện thành công, hệ thống được xem là đã hoàn thành **luồng kiểm thử chức năng cơ bản của CarCare Manager**.

Luồng kiểm thử này giúp kiểm tra:

* Hệ thống có khởi động đúng hay không.
* Menu có hoạt động đúng hay không.
* Các module có hoạt động độc lập hay không.
* Dữ liệu có được truyền và sử dụng đúng giữa các module hay không.
* Báo cáo có tổng hợp chính xác hay không.
* Dữ liệu có bị xóa sau khi kết thúc phiên hay không.
